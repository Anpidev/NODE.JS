...
const fs = require('node:fs/promises'); // Para trabajar con el sistema de archivos de manera asíncrona
const path = require('node:path'); // Para manejar rutas de archivos y directorios
